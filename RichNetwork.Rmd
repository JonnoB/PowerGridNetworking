...
DeleteNodes <- DegreeAttack(gbase, Number = vcount(g))
...
NodesTarget, Folder = "worst", filename = "worst"ed(testattack)
...
CreateCascadeGif(unlist(CheckCollapse, recursive = F))
