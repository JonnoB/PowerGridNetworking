...
attack_the_grid <- function(g,
  ...
  edge_capacity_vector <- edge_attr(g, name = edge_capacity)
  ...
  edge_power  <- abs(edge_power[,  1:(CumulativeAttacks + 1)])# %*% diag(1/edge_attr(g0, name = edge_capacity))   #edge capacity
